# Report for 'install lua 5.2.4-1 ssh'
...
- **ssh 0.0.1-0**
    - **remote:** git://github.com/LuaDist-testing/ssh.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/ssh 0.0.1-0
...
### ssh 0.0.1-0
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/ssh 0.0.1-0/ssh-0.0.1-0.rockspec'
- **Error:** Could not generate cmake commands for package 'ssh 0.0.1-0': Unhandled rockspec build type: "make"
