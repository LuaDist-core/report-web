...
- **lightningmdb 0.9.22.1-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/lightningmdb 0.9.22.1-1
...
### lightningmdb 0.9.22.1-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/lightningmdb 0.9.22.1-1/lightningmdb-0.9.22.1-1.rockspec'
- Generated CMake file in '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/lightningmdb 0.9.22.1-1'
- Building into '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/lightningmdb 0.9.22.1-1-build'
- **CMake Variables:**
    - `CMAKE_BUILD_WITH_INSTALL_RPATH` = FALSE
    - `CMAKE_INCLUDE_PATH` = ;/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/include
    - `CMAKE_INSTALL_NAME_DIR` = @executable_path/../lib
    ...
    - `INSTALL_LMOD` = lib/lua
    - `INSTALL_SHARE` = share
- **Error:** Error building package 'lightningmdb 0.9.22.1-1': Could not build with CMake in directory '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/lightningmdb 0.9.22.1-1-build'
stdout:
Scanning dependencies of target lightningmdb
[ 50%] Building C object CMakeFiles/lightningmdb.dir/lightningmdb.c.o

stderr:
/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/lightningmdb 0.9.22.1-1/lightningmdb.c:10:18: fatal error: lmdb.h: No such file or directory
 #include "lmdb.h"
                  ^
