# Report for 'install lua 5.2.4-1 lua-ddlt'
...
- **lua-ddlt 2.8-2**
    - **remote:** git://github.com/LuaDist-testing/lua-ddlt.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/lua-ddlt 2.8-2
...
### lua-ddlt 2.8-2
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/lua-ddlt 2.8-2/lua-ddlt-2.8-2.rockspec'
- **Error:** Could not generate cmake commands for package 'lua-ddlt 2.8-2': Unhandled rockspec build type: "make"
