...
- **wtf-action-html_response 0.1-2**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2
- **wtf-plugin-honeybot-fake-welcome-data 0.1-2**
    - **remote:** git://github.com/LuaDist-testing/wtf-plugin-honeybot-fake-welcome-data.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-plugin-honeybot-fake-welcome-data 0.1-2
- **wtf-plugin-honeybot-fake-welcome 0.2-1**
    - **remote:** git://github.com/LuaDist-testing/wtf-plugin-honeybot-fake-welcome.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-plugin-honeybot-fake-welcome 0.2-1
...
### wtf-action-html_response 0.1-2
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2/wtf-action-html_response-0.1-2.rockspec'
- Generated CMake file in '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2'
- Building into '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2-build'
- **CMake Variables:**
    - `CMAKE_BUILD_WITH_INSTALL_RPATH` = FALSE
    - `CMAKE_INCLUDE_PATH` = ;/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/include
    - `CMAKE_INSTALL_NAME_DIR` = @executable_path/../lib
    ...
    - `INSTALL_LMOD` = lib/lua
    - `INSTALL_SHARE` = share
- Executing 'cd "/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2-build" && cmake -P cmake_install.cmake'
- Removing '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2'
- Removing '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-action-html_response 0.1-2-build'

- *hint:* If you wish to keep these directories, set the debug flag
- Updating local manifest at '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/share/luadist2/manifest-file'

### wtf-plugin-honeybot-fake-welcome-data 0.1-2
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-plugin-honeybot-fake-welcome-data 0.1-2/wtf-plugin-honeybot-fake-welcome-data-0.1-2.rockspec'
