# Report for 'install lua 5.1.5-1 loldb'
...
- **lua-leveldb 0.4-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.1.5-1/install/tmp/lua-leveldb 0.4-1
- **loldb 0.0.1-0**
    - **remote:** git://github.com/LuaDist-testing/loldb.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.1.5-1/install/tmp/loldb 0.0.1-0
...
### lua-leveldb 0.4-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.1.5-1/install/tmp/lua-leveldb 0.4-1/lua-leveldb-0.4-1.rockspec'
