...
- **pe-parser 0.5.0-2**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/pe-parser 0.5.0-2
...
### pe-parser 0.5.0-2
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/pe-parser 0.5.0-2/pe-parser-0.5.0-2.rockspec'
- Generated CMake file in '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/pe-parser 0.5.0-2'
- Building into '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/pe-parser 0.5.0-2-build'
- **CMake Variables:**
    - `CMAKE_BUILD_WITH_INSTALL_RPATH` = FALSE
    - `CMAKE_INCLUDE_PATH` = ;/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/include
    - `CMAKE_INSTALL_NAME_DIR` = @executable_path/../lib
    ...
    - `INSTALL_LMOD` = lib/lua
    - `INSTALL_SHARE` = share
- Executing 'cd "/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/pe-parser 0.5.0-2-build" && cmake -P cmake_install.cmake'
- **Error:** Could not install package 'pe-parser 0.5.0-2' from directory '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.3.2/install/tmp/pe-parser 0.5.0-2-build'
stdout:
...
CMake Error at cmake_install.cmake:36 (file):
  ...
  5.3.2/install/tmp/pe-parser 0.5.0-2/docs".
