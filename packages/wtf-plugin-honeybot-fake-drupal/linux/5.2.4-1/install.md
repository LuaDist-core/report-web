# Report for 'install lua 5.2.4-1 wtf-plugin-honeybot-fake-drupal'
...
- **wtf-plugin-honeybot-fake-drupal-data 0.3-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-plugin-honeybot-fake-drupal-data 0.3-1
- **lua-cjson 2.1.0.6-1**
...
- **wtf-plugin-honeybot-fake-drupal 0.6-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-plugin-honeybot-fake-drupal 0.6-1
...
### wtf-plugin-honeybot-fake-drupal-data 0.3-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/wtf-plugin-honeybot-fake-drupal-data 0.3-1/wtf-plugin-honeybot-fake-drupal-data-0.3-1.rockspec'
