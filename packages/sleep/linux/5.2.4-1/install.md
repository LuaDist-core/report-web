...
- **sleep 1.0.0-3**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3
...
### sleep 1.0.0-3
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3/sleep-1.0.0-3.rockspec'
- Package 'sleep 1.0.0-3': using CMakeLists.txt provided by package itself
- Building into '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3-build'
- **CMake Variables:**
    - `CMAKE_BUILD_WITH_INSTALL_RPATH` = FALSE
...
- **Error:** Error building package 'sleep 1.0.0-3': Could not preload the CMake cache script '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3-build/cmake.cache'
stdout:
...
See also "/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3-build/CMakeFiles/CMakeOutput.log".
See also "/home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3-build/CMakeFiles/CMakeError.log".
...
CMake Error at /usr/local/cmake-3.9.2/share/cmake-3.9/Modules/CMakeTestCCompiler.cmake:51 (message):
  ...
  It fails with the following output:
   ...
   Change Dir: /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/sleep 1.0.0-3-build/CMakeFiles/CMakeTmp

  

  Run Build Command:"/usr/bin/make" "cmTC_dd13a/fast"

  /usr/bin/make -f CMakeFiles/cmTC_dd13a.dir/build.make
  CMakeFiles/cmTC_dd13a.dir/build

  make[1]: Entering directory
  `/home/travis/build/LuaDist-testing/_luadist_output/lua
  5.2.4-1/install/tmp/sleep 1.0.0-3-build/CMakeFiles/CMakeTmp'

  Building C object CMakeFiles/cmTC_dd13a.dir/testCCompiler.c.o

  /usr/bin/gcc -o CMakeFiles/cmTC_dd13a.dir/testCCompiler.c.o -c
  "/home/travis/build/LuaDist-testing/_luadist_output/lua
  5.2.4-1/install/tmp/sleep
  1.0.0-3-build/CMakeFiles/CMakeTmp/testCCompiler.c"

  Linking C executable cmTC_dd13a

  /usr/local/cmake-3.9.2/bin/cmake -E cmake_link_script
  CMakeFiles/cmTC_dd13a.dir/link.txt --verbose=1

  /usr/bin/gcc $(CFLAGS) -rdynamic
  CMakeFiles/cmTC_dd13a.dir/testCCompiler.c.o -o cmTC_dd13a

  gcc: error: $(CFLAGS): No such file or directory

  make[1]: *** [cmTC_dd13a] Error 1

  make[1]: Leaving directory
  `/home/travis/build/LuaDist-testing/_luadist_output/lua
  5.2.4-1/install/tmp/sleep 1.0.0-3-build/CMakeFiles/CMakeTmp'

  make: *** [cmTC_dd13a/fast] Error 2
