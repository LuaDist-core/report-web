...
# Report for 'install lua 5.1.5-1 dromozoa-jpeg'
...
- **dromozoa-jpeg 1.3-1**
    - **remote:** git://github.com/LuaDist-testing/dromozoa-jpeg.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.1.5-1/install/tmp/dromozoa-jpeg 1.3-1
...
### dromozoa-jpeg 1.3-1
- Loaded rockspec from '/home/travis/build/LuaDist-testing/_luadist_output/lua 5.1.5-1/install/tmp/dromozoa-jpeg 1.3-1/dromozoa-jpeg-1.3-1.rockspec'
- **Error:** Could not generate cmake commands for package 'dromozoa-jpeg 1.3-1': Unhandled rockspec build type: "make"
- **Error:** Error installing: Could not generate cmake commands for package 'dromozoa-jpeg 1.3-1': Unhandled rockspec build type: "make"
