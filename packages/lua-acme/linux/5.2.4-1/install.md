...
- **lua-jwc 0.2-1**
    ...
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/lua-jwc 0.2-1
- **lua-acme 0.6-2**
    - **remote:** git://github.com/LuaDist-testing/lua-acme.git
    - **local:** /home/travis/build/LuaDist-testing/_luadist_output/lua 5.2.4-1/install/tmp/lua-acme 0.6-2
